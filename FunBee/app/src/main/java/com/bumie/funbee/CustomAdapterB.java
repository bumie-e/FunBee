...
public class CustomAdapterB extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    ArrayList<Model> list;
    public static final int MESSAGE_TYPE_IN = 1;
    public static final int MESSAGE_TYPE_OUT = 2;

    public CustomAdapterB(Context context, ArrayList<Model> list) { // you can pass other parameters in constructor
    ...
    private class MessageInViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(int position) {
            Model messageModel = list.get(position);
